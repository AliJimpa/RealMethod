...
namespace RealMethod.Editor
{
    class Pickup_ScriptTemplate
    {
        ...
        {
            string Path = RM_Editor.CreateScriptTemplate("Pickup3DTemplate.txt", "MyPickup.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Toolkit/Pickup/Pickup2D", false, 80)]
        public static void CreatePickup2D()
        {
            string Path = RM_Editor.CreateScriptTemplate("Pickup2DTemplate.txt", "MyPickup.cs");
        }
    }
}