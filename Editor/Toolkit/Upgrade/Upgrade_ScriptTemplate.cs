...
namespace RealMethod.Editor
{
    class Upgrade_ScriptTemplate
    {
        ...
        {
            string Path = RM_Editor.CreateScriptTemplate("UpgradeItemTemplate.txt", "MyUpgradeAsset.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Toolkit/Upgrade/MapConfig", false, 80)]
        public static void CreateConfig()
        {
            string Path = RM_Editor.CreateScriptTemplate("UpgradeConfigTemplate.txt", "MyUpgradeConfig.cs");
        }
    }
}