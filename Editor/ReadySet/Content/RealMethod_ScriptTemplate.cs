...
namespace RealMethod.Editor
{
    class RealMethodScriptTemplate
    {
        ...
        {
            string Path = RealMethod.CreateScriptTemplate("GameTemplate.txt", "MyGame.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Essential/World", false, 80)]
        public static void CreateWorld()
        {
            string Path = RealMethod.CreateScriptTemplate("WorldTemplate.txt", "MyWorld.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Essential/GameBridge", false, 80)]
        public static void CreateGameBridgeClass()
        {
            string Path = RealMethod.CreateScriptTemplate("GameBridgeTemplate.txt", "MyGameBridge.cs");
        }
        ...
        {
            string Path = RealMethod.CreateScriptTemplate("ServiceTemplate.txt", "MyServicec.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Service/StateService", false, 80)]
        public static void CreateStateService()
        {
            string Path = RealMethod.CreateScriptTemplate("StateServiceTemplate.txt", "MyStateService.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Service/RuleService", false, 80)]
        public static void CreateRuleService()
        {
            string Path = RealMethod.CreateScriptTemplate("RuleServiceTemplate.txt", "MyRuleService.cs");
        }
        ...
        {
            string Path = RealMethod.CreateScriptTemplate("SharedRootAssetTemplate.txt", "MySharedRootAsset.cs");
        }
        [MenuItem("Assets/Create/Scripting/RealMethod/Asset/Unique/PoolAsset", false, 80)]
        public static void CreatePoolAsset()
        {
            string Path = RealMethod.CreateScriptTemplate("PoolAssetTemplate.txt", "MyPoolAsset.cs");
        }
        ...
        {
            string Path = RealMethod.CreateScriptTemplate("SettingSectionTemplate.txt", "MySection.cs");
        }
