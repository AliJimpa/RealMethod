...
namespace RealMethod.Editor
{
    ...
    public class HelpNode
    {
        ...
        public List<HelpNode> children = new List<HelpNode>();
    }

    public class HelpWindow : EditorWindow
    {
        private List<HelpNode> rootNodes = new List<HelpNode>();
        private Dictionary<HelpNode, bool> foldoutStates = new Dictionary<HelpNode, bool>();
