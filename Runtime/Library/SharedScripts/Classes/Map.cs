...
namespace RealMethod
{
    ...
    [Serializable]
    public abstract class MapCore<TKey, TValue, TValueStorage> : MapCore, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
        ...
        protected MapCore(SerializationInfo info, StreamingContext context)
        {
        ...
        public MapCore(IDictionary<TKey, TValue> dict)
        {
    ...
    {
        public class Storage<T> : MapCore.Storage
        {
            public T data;
        }
    }
    ...
    [Serializable]
    public class Map<TKey, TValue> : MapCore<TKey, TValue, TValue>
    {
        public Map() { }
    ...
    [Serializable]
    public class Map<TKey, TValue, TValueStorage> : MapCore<TKey, TValue, TValueStorage> where TValueStorage : SerializableDictionary.Storage<TValue>, new()
    {
        public Map() { }
        public Map(IDictionary<TKey, TValue> dict) : base(dict) { }
        protected Map(SerializationInfo info, StreamingContext context) : base(info, context) { }
