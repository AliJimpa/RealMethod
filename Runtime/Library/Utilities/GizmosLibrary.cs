...
namespace RealMethod
{
    public static class RM_Gizmos
    {
        ...
        /// <summary>
        /// Draws a directional arrow in the scene for debugging or visualization.
        /// </summary>
        /// <param name="position">The starting position of the arrow.</param>
        /// <param name="direction">The direction the arrow points to.</param>
        /// <param name="arrowHeadLength">Length of the arrow head.</param>
        /// <param name="arrowHeadAngle">Angle of the arrow head in degrees.</param>
        /// <remarks>
        /// Typically used for debugging directions, forces, or movement in the Scene view.
        /// Implementation may use <c>Debug.DrawLine</c> or <c>Gizmos</c>.
        /// </remarks>
