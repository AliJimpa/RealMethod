...
namespace RealMethod
{
    ...
    public abstract class World_Old : MonoBehaviour
    {
        [Header("World_Old")]
        [SerializeField]
        ...
        {
            World_Old TopWorld = Game_old.World_Old;
            if (TopWorld)
            {
                if (AdditiveWorld)
                {
        ...
        private void InitiateWorld()
        {
            ...
            Game_old.Instance.OnWorldUpdate(this);
            Game_old.Setting.OnNewService += OnServiceCreated;
        ...
        protected virtual void OnAdditiveWorldActive(World_Old TopWorld)
        {
            Destroy(this);
        }
