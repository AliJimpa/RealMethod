...
namespace RealMethod
{
    public abstract class BaseInventory : MonoBehaviour
    {
        ...
        // Abstract Methods 
        protected abstract void InventoryAwake();
    }
    public abstract class InventoryStorage : BaseInventory
    {
        [Header("Save")]
        [SerializeField]
        ...
        // override Methods
        protected override void InventoryAwake()
        {
            if (LoadOnAwake)
            {
    ...
    public abstract class ItemAsset : DataAsset
    {
        ...
        public abstract void PickedUp(BaseInventory owner, int quantity);
        public abstract void Cahanged(int quantity);
        public abstract void Dropped(BaseInventory owner);
        public abstract bool CanChange(bool IsAdded);
        public abstract bool CanPickUp(BaseInventory owner);
        public abstract bool CanDropp(BaseInventory owner);
    }
    ...
    {
        ItemProperty[] LoadInventory(BaseInventory owner);
        void SaveInventory(BaseInventory owner, ItemProperty[] Data);
        bool IsExistInventoryData(BaseInventory owner);
