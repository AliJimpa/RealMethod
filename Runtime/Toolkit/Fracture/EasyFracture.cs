...
{
    [AddComponentMenu("RealMethod/Toolkit/Fracture/EasyFracture")]
    public class EasyFracture : MonoBehaviour
    {
        ...
        public void DestroyMesh()
        {
            ...
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                parts[i].GameObject.name = this.name + i.ToString();
                parts[i].GameObject.GetComponent<Rigidbody>().AddForceAtPosition(parts[i].Bounds.center * ExplodeForce, transform.position);
                parts[i].GameObject.layer = gameObject.layer;
                if (this.transform.parent)
                    parts[i].GameObject.transform.SetParent(this.transform.parent);
            }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(EasyFracture original)
        {
